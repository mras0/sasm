...
static const struct InstructionInfo Instructions[256] = {
    ...
    [0x91] = { N_XCHG   , R_AX        , R_CX        },
    [0x92] = { N_XCHG   , R_AX        , R_DX        },
    [0x93] = { N_XCHG   , R_AX        , R_BX        },
    [0x94] = { N_XCHG   , R_AX        , R_SP        },
    [0x95] = { N_XCHG   , R_AX        , R_BP        },
    [0x96] = { N_XCHG   , R_AX        , R_SI        },
    [0x97] = { N_XCHG   , R_AX        , R_DI        },
    ...
    [0xA8] = { N_TEST   , R_AL        , OTYPE_IMM8  },
    [0xA9] = { N_TEST   , R_AX        , OTYPE_IMM16 },
